...
contract ExpToken is ERC20, Ownable {
    ...
    constructor(address initialOwner, address _hub, address _profileHandle) ERC20("ExpToken", "EXP") Ownable(initialOwner) {
    ...
    function burn(address from, uint256 _amount) public onlyHub {
        _burn(from, _amount);
    }
}